...
from sample_env_online import freq_env
from matplotlib.backends.backend_tkagg import FigureCanvasTkAgg
from matplotlib.figure import Figure
import tkinter as tk

ENV_NAME = 'DQN_online'#'Breakout-v0'  # Environment name
...
INITIAL_REPLAY_SIZE = 2000  # 2000Number of steps to populate the replay memory before training starts
NUM_REPLAY_MEMORY = 5000  # 5000Number of replay memory the agent uses for training
BATCH_SIZE = 32  # 32Mini batch size
    ...
    if TRAIN:  # Train mode
        for _ in range(NUM_EPISODES):
            ...
            while not terminal:
                ...
                waterfall_figure.imshow(observation[0, :, :, 0],interpolation='nearest',aspect='auto')
                canvas.draw()
                """
